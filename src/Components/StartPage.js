      ...
      pages: [
        {
          questions: [
...

            {
              ...
              name: "info",
              html:
                "<p>Adults aged between <strong>18 to 40 years old</strong> who have <strong>normal hearing</strong>. This means that you need to have <strong>no history of auditory/hearing condition (current & past)</strong>, including: <ul><li>Personal history of or current Tinnitus</li><li>Personal history of or current hearing sensitivity (e.g. Hyperacusis)</li><li>Personal history of or current hearing loss</li><li>Personal history of or current use of hearing aid</li><li>Current ear infections/inflammation</li></ul> Please also note that this study requires the use of <strong>earphones/headphones</strong> and must be completed using a <strong>desktop/laptop</strong> (not a tablet/mobile phone) throughout the whole study. <br/><br/>If you take part in this study, you confirm that you meet the eligibity criteria.</p>",
            },
...

            {
              ...
              name: "info",
              html:
                "<p> You will play one or more online computer tasks, which will last around approximately <strong>30 mins</strong>. <br/><br/>You will receive brief, unpleasant noises during some parts of the computer task(s). Before the start of the computer task, the volume of the noises will be adjusted to a level that is loud but that you are able to tolerate comfortably. This is in order to find a level that is appropriate for the experiment so that any unpleasant noises are not played   more intense than you are comfortable with. <br/><br/>You will also be asked some questions about yourself, your feelings, background, attitudes and behaviour in your everyday life. <br/><br/>Please note that <strong>the use of earphones/headphones is required throughout the whole study</strong>. <br/><br/>You will receive <strong>4.13 GBP</strong> for helping us. <br/><br/>Remember, you are free to withdraw at any time without giving a reason.</p>",
            },
